...
def argument_parser():
    ...
    # Architecture
    # ************************************************************
    parser.add_argument('-a', '--arch', type=str, default='abd_resnet50')
...
def image_dataset_kwargs(parsed_args):
    ...
    """
    return {
        'sources': parsed_args.source_names,
        'targets': parsed_args.target_names,
        'root': parsed_args.root,
        'split_id': parsed_args.split_id,
        'height': parsed_args.height,
        'width': parsed_args.width,
        'batch_size_train': parsed_args.train_batch_size,
        'batch_size_test': parsed_args.test_batch_size,
        ...
        'transforms': parsed_args.data_augment,
